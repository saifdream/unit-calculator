...
class Sphere extends Component {
    ...
    setResult() {
        this.setState({ result: 4 / 3 * this.state.pi * Math.pow(this.state.unitValue, 3) });
    }

    getResult() {
        return this.state.result ? <p style={{fontSize: 20}}>Volume = 4/3×π×{this.state.unitValue}³ = <strong>{this.state.result} {this.state.unit}³</strong></p> : '';
    }
            ...
            <Form style={{ paddingTop: 30 }}>
                <Row>
                    <Col sm={12} style={{ textAlign: 'center', paddingBottom: 30 }}>
                        <Image src={require('../../../img/volumes/ball.png')} rounded />
                    </Col>
                </Row>
                <Form.Group as={Row}>
                    ...
                    <Col sm="4">
                        <Form.Control type="number" value={this.state.unitValue} onChange={this.unitValueChange} placeholder="Radius" />
                    </Col>
                    <Col sm="4">
